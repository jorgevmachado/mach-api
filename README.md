...
4. It is recommended to create a `.env` file at the root with the variables:
   ...
   For PostgreSQL:
   ```env
   DATABASE_URL=postgresql+psycopg://user:password@localhost:5432/mach_db
   ```
### Installation
...
1. Clone the repository:
   ```bash
   git clone https://github.com/jorgevmachado/mach-api.git
   cd mach-api
   ```
...
See the [open issues](https://github.com/jorgevmachado/mach-api/issues) for the full list of proposed features and known issues.
...
Project Link: [https://github.com/jorgevmachado/mach-api](https://github.com/jorgevmachado/mach-api)
